                ...
                <div class="">
                    <div class="mx-auto max-w-7xl px-4 sm:px-8 lg:px-8">
                        ...
                        <div class="mx-auto max-w-2xl py-16 sm:py-24 lg:max-w-none lg:py-10">
                            <h2 class="text-2xl font-bold blue-1">Artikel</h2>

                            <div class="mt-6 lg:grid lg:grid-cols-3 lg:gap-14">
                                @foreach ($articles as $article)
                                    <div class="mb-6 border-2 border-blue-1 rounded-lg p-4">
                                    ...
                                    <img src="https://tailwindui.com/plus/img/ecommerce-images/home-page-02-edition-01.jpg"
                                        ...
                                        <div class="mt-4 text-center">
                                            <a href="{{ route('articles.show', $article->id) }}" class="bg-blue-1 text-black font-bold py-2 px-4 rounded">
                                                Lebih Banyak
                                            </a>
                                        </div>
                                    </div>
                                        ...
                                        @for ($i = 1; $i <= $articles->lastPage(); $i++)
                                            <li>
                                                <a href="{{ $articles->url($i) }}"
                                                    ...
                                                    {{ $articles->currentPage() == $i ? 'bg-blue-1 text-black rounded-full' : 'blue-1' }}">
                                                    {{ $i }}
                                                </a>
                                            </li>
                                        @endfor
